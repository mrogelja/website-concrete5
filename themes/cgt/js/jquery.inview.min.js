(function (d) {
    ...
    d.event.special.inview = {add: function (a) {
    ...
    setInterval(function () {
        ...
        if (j = k.length) {
            ...
            e = b;
            for (a = a || {top: i.pageYOffset || f.scrollTop || h.body.scrollTop, left: i.pageXOffset || f.scrollLeft || h.body.scrollLeft}; n < j; n++)if (d.contains(f, k[n])) {
                b = d(k[n]);
...
/**
 * Created by Mathieu on 09/02/14.
 */
