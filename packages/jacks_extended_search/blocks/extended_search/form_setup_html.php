...
<table id="searchBlockSetup" width="100%"> 
	...
	<tr>
		<th><?php echo t('Search Placeholder')?>:</th>
		<td><input name="searchPlaceholder" value="<?php  echo $searchObj->searchPlaceholder ?>" maxlength="255" type="text" style="width:100%"></td>
	</tr>
	<tr>
