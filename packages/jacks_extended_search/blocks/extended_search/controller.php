...
class ExtendedSearchBlockController extends BlockController {
	
	public $pobj;
	  
	protected $btTable = 'btExtendedSearch';
    ...
    public $dontDisplayResults = false;
	...
	public function getBlockTypeDescription() {
		return t("A more advanced search box for your site.");
	}
	...
	function view(){
        ...
        $this->set('dontDisplayResults', $this->dontDisplayResults);
	...
	function save($data) { 
		...
		$args['searchPlaceholder'] = isset($data['searchPlaceholder']) ? $data['searchPlaceholder'] : '';
